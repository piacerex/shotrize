defmodule Mix.Tasks.Shotrize.Apply do
	...
	def run( _args ) do
		...
		create_file( controller_file_path( "page_controller.ex" ), spa_template( app_module: file_app_module ) )
		create_file( shotrize_file_path( "api_controller.ex" ), spa_template( app_module: file_app_module ) )
		create_file( shotrize_file_path( "rest_api_controller.ex" ), spa_template( app_module: file_app_module ) )
	end
